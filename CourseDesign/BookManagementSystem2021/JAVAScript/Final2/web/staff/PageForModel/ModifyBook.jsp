    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="${pageContext.request.contextPath}/ChangeBookByStaff" accept-charset="UTF-8">
                    <input type="hidden" id="updatespecimenId" name="updatesid3">
                    ...
                    <label for="picture3">图书照片</label>
                    <input name="picture3" id="picture3" type="text" class="form-control" readonly>
